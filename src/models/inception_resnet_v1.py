...
def inference(images, keep_probability, phase_train=True, 
    ...
    batch_norm_params = {
        # phân rã cho các đường trung bình
        'decay': 0.995,
        # epsilon để ngăn 0s trong phương sai
        'epsilon': 0.001,
        # cập nhật chỗ ước tính trung bình và phương sai
        'updates_collections': None,
        # kết thúc trung bình di chuyển trong các biến có thể huấn luyện
